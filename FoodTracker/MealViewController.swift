...
//  FoodTracker
//
//  Created by Paladugu, Navya on 12/20/17.
//  Copyright © 2017 Paladugu, Navya. All rights reserved.
//
...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Set up the views if the editing an existing Meal.
        if let meal = meal {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // Configure the destinationn view controller only when the save button is pressed.
